...
gurobi> m.update()
gurobi> nut1_con = m.addConstr(2*x1 + 3*x3 + 1*x4 + 2*x5 >= 21, 'nutrient.iron')
gurobi> nut2_con = m.addConstr(1*x2 + 2*x3 + 2*x4 + 1*x5 >= 12, 'nutrient.calcium')
gurobi> m.optimize()
...
gurobi> x5 = m.addVar(lb = 0, ub = GRB.INFINITY, obj = 12, vtype = GRB.CONTINUOUS, name = 'food.5')
gurobi> m.update()
\color{red}gurobi> nut1_con = m.addConstr(2*x1 + 3*x3 + 1*x4 + 2*x5 >= 21, 'nutrient.iron')
\color{red}gurobi> nut2_con = m.addConstr(1*x2 + 2*x3 + 2*x4 + 1*x5 >= 12, 'nutrient.calcium')
gurobi> m.optimize()
Optimize a model with 2 rows, 5 columns and 8 nonzeros
Iteration    Objective       Primal Inf.    Dual Inf.      Time
       0    0.0000000e+00   1.125000e+01   0.000000e+00      0s
